...
router.post("/delete-account-request", async (req, res) => {
  ...
  try {
    await transporter.sendMail({
      from: `"Pocket Somm" <${process.env.EMAIL_USER}>`,
      to: email,
      subject: "Your Pocket Somm account deletion request",
      html: `
        <div style="font-family: sans-serif; max-width: 520px; margin: 0 auto;">
          <h2 style="color: #8b1a1a;">Account Deletion Request Received</h2>
          <p>We received a request to permanently delete your Pocket Somm account for <strong>${safeEmail}</strong>.</p>
          ...
          <p>If you did not make this request, contact us at getpocketsomm@gmail.com immediately.</p>
    ...
    await transporter.sendMail({
      ...
      subject: `[Pocket Somm] Account deletion request`,
      html: `
